...
namespace GateDemo3
{
    public partial class Form4AA : Form4A
    {
        ...
        private void button2_Click(object sender, EventArgs e) //ice tea
        {
            Form4.subtotal = Form4.subtotal + 1.5;
            if (Form4.index < 11)
            {
        ...
        private void button3_Click(object sender, EventArgs e) // black tea
        {
            Form4.subtotal = Form4.subtotal + 3;
        ...
        private void button5_Click(object sender, EventArgs e) // green tea
        {
            Form4.subtotal = Form4.subtotal + 3;
        ...
        private void button4_Click(object sender, EventArgs e) //freddo espresso
        {
            Form4.subtotal = Form4.subtotal + 4;
            if (Form4.index < 11)
            {
                DialogResult dialogResult = MessageBox.Show("Προστεθηκε στο λογαριασμό", "Μήνυμα επιβεβαίωσης", MessageBoxButtons.OK);
                if (dialogResult == DialogResult.OK)
        ...
        private void button6_Click(object sender, EventArgs e) // cappuccino freddo
        {
            Form4.subtotal = Form4.subtotal + 4.5;
            if (Form4.index < 11)
            {
                DialogResult dialogResult = MessageBox.Show("Προστεθηκε στο λογαριασμό", "Μήνυμα επιβεβαίωσης", MessageBoxButtons.OK);
                if (dialogResult == DialogResult.OK)
        ...
        private void Form4AA_Load(object sender, EventArgs e)
        {
